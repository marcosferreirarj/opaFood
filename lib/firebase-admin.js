...
function createAdminApp() {
  ...
  if (!isCredentialValid) {
    console.warn('\x1b[33m%s\x1b[0m', '⚠️  [Firebase Admin] Credenciais ausentes ou incompletas em .env.local');
    console.warn('\x1b[33m%s\x1b[0m', '   Operações administrativas (como listar lojas) podem falhar.');
