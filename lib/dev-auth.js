...
export const DEV_PRODUCTS = [
  { id: 'dev-prod-1', name: 'X-Burguer',       description: 'Pão brioche, carne 180g, queijo',    price: 25.9, isAvailable: true,  imageUrl: null },
  { id: 'dev-prod-2', name: 'Frango Crispy',    description: 'Frango empanado crocante com salada', price: 22.5, isAvailable: true,  imageUrl: null },
  { id: 'dev-prod-3', name: 'Coca-Cola 350ml',  description: '',                                    price: 6.0,  isAvailable: false, imageUrl: null },
];
